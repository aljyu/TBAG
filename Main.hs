...
doChoice1 character = do
                                        let currentPlayer = keep character
                                        ...
                                        input <- getLine
                                        let newPlayer = move currentPlayer
                                        --if input == "KITCHEN" then do goToKitchen
                                        --else if input == "DOG HOUSE" then do goToDogHouse 
                                        --else if input == "BACKYARD" then do goToBackyard
                                        if input == "status" then do status newPlayer
                                        else putStrLn "Command not recognized. Please try again.\n"
                                        let character = newPlayer
                                        --status player
                                        doChoice1 character
