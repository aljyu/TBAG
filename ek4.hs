...
goToOptions1 character = do
     ...
     input <- getLine
     let playerNow = character
     if input == "KITCHEN"
       then do goToKitchen playerNow
       --else if input == "DOG HOUSE"
       --       then do goToDogHouse
       --       else if input == "BACKYARD"
       --            then do goToBackyard
                   else if input == "status"
                      then do (status playerNow)
                              goToOptions1 character
   ...
   if input == "LOOK INSIDE THE SINK"
     ...
     --                    goToBackyard
                      ...
                      then do (status playerNow) 
                              ...
                              goToKitchen character --loop back to fuction
