...
printStatus :: Player -> IO()
printStatus (Player {hp = h, potions = p}) = putStrLn ("Player has " ++ (show (h)) ++ " HP and " ++ (show p) ++ " potions")
...
doChoice1 character = do
                                        ...
                                        input <- getLine
                                        if input == "STATUS" then printStatus character
...
goToKitchen str character = do
                                                ...
                                                input <- getLine
                                                if input == "STATUS" then printStatus newPlayer
